...
- Done when: shelf photo, notebook photo, and supplier offer photo all produce editable drafts.
- Key files: `src/bot/*`, extraction adapters, intake tests.

### Track B: Core records and checks
- Scope: product/supplier/inventory/sales/offer models and append-only event logic.
...
- Scope: compute low-stock list and propose purchase quantities using latest offers.
