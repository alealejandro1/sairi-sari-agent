...
- Core data layer: products, inventory, sales, customers, utang ledger pages/entries, loans, cash/owner check-ins, health snapshots.
- Insight layer: margin warning, price consistency warning, weekly health trend.
